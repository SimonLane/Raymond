...
class ViewFinder(QtWidgets.QLabel):
    ...
    def __init__(self, parent):
        ...
        self.pen_color = QtGui.QColor('#888888')
    ...
    def mouseDoubleClickEvent(self, e):
        ...
        painter.setPen(p)
        painter.drawLine(e.x()-10, e.y()-10,e.x()-7, e.y()-10)
        painter.drawLine(e.x()-10, e.y()-10,e.x()-10, e.y()-7)
        painter.drawLine(e.x()-10, e.y()+10,e.x()-7, e.y()+10)
        painter.drawLine(e.x()-10, e.y()+10,e.x()-10, e.y()+7)
        painter.drawLine(e.x()+10, e.y()-10,e.x()+7, e.y()-10)
        painter.drawLine(e.x()+10, e.y()-10,e.x()+10, e.y()-7)
...
# =============================================================================
    ...
    def update_modifier_image(self):
        ...
        flat_image = np.ones((640,1024),dtype=np.uint8) * mean
