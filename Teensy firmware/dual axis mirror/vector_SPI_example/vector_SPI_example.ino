...
// Setup the scan mirror to perform a perdefined vector X axis each time a trigger pulse is received.
// Y is static. Also increments the Y position between each X scan

// input stage
  sendWriteSPI(0x60005102,0x02,generateSPFPR(0));                         //Select signal generator system as active input for X and static value for Y axis.
