...
@author: Simon
"""
import sys, time, threading, datetime, queue
import pandas           as pd
import numpy            as np
...
#~~~~~~~~~~~~~~~ Experiment progress Pane ~~~~~~~~~~~~~~~ 
        ...
        self.progress_c.setFixedHeight(20)
        ...
        self.ProgressGroup.layout().addWidget(self.progress_c_label,          0,0,1,0)
        self.ProgressGroup.layout().addWidget(self.progress_z_label,          1,0,3,0)
        self.ProgressGroup.layout().addWidget(self.progress_p_label,          2,0,3,0)
        self.ProgressGroup.layout().addWidget(self.progress_t_label,          3,0,3,0)
        self.ProgressGroup.layout().addWidget(self.progress_c,                0,1,5,0)
        self.ProgressGroup.layout().addWidget(self.progress_z,                1,3,5,0)
        self.ProgressGroup.layout().addWidget(self.progress_p,                2,3,5,0)
        self.ProgressGroup.layout().addWidget(self.progress_t,                3,3,5,0)
...
#Right-hand column
        ...
        OverallLayout.addWidget(self.ImageDisplayGroup,             0,0,16,12) 
        OverallLayout.addWidget(self.InfoGroup,                     16,16,3,5) 
        OverallLayout.addWidget(self.ProgressGroup,                 16,12,3,4) 

        self.MainArea = QtWidgets.QFrame()
        self.MainArea.setStyleSheet("""font: 10pt Modum;""")
